...
from fairspec_table.plugins.parquet.settings import NATIVE_TYPES
...
def save_parquet_table(table: Table, **options: Unpack[SaveTableOptions]) -> str:
    path = options["path"]
    ...
    table.sink_parquet(path, engine=QUERY_ENGINE)
